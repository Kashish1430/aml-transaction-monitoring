...
- **Phase 5 onward — NOT STARTED.** Next up: `src/evaluate.py` — precision@k, recall-per-typology, PR-AUC/calibration as reported metrics, and the headline false-positive-reduction-vs-rules-baseline-at-equal-recall number.
